...
const components = {
  ...
  ul: (props) => <ul className="text-gray-300 mb-3 sm:mb-4 ml-6 sm:ml-8 list-disc text-sm sm:text-base" {...props} />,
  ol: (props) => <ol className="text-gray-300 mb-3 sm:mb-4 ml-6 sm:ml-8 list-decimal text-sm sm:text-base" {...props} />,
